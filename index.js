...
setInterval(async () => {
const statuses = [`DECΩDERS™`, `| Made by ${owner}`]
   client.user.setActivity(statuses[Math.floor(Math.random() * statuses.length)], { type: "WATCHING", text: "Playing with Trung#0639"})
}, 10000)
});
...
client.on("message", async message => {
  if (message.channel.type === "dm") {
    ...
    const chat = new Chat({ name: "DECΩDERS™", gender: "male", developer_name: "Trung#0639", user: "945884494827761725", language: "en" }); //put a random id here
